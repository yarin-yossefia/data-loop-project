...
DOMAIN_OR_IP="dataloopwebapp-staging.com"
SECRET_NAME="frontend-tls-secret-staging"
NAMESPACE="services"

echo "Generating self-signed certificate for: $DOMAIN_OR_IP"

openssl genrsa -out tls.key 2048

openssl req -new -key tls.key -out tls.csr -subj "/CN=$DOMAIN_OR_IP/O=MyOrg"
